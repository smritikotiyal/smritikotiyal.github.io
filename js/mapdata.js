var simplemaps_worldmap_mapdata={
  ...
  state_specific: {
    ...
    IN: {
      ...
      description: "default",
      color: "Orange",
      hover_color: "Light Orange",
      url: "https://simplemaps.com/static/img/frog.png"
    },
    IE: {
      name: "Ireland",
      description: "default",
  ...
  locations: {
    "0": {
      ...
      name: "Melbourne",
      color: "Green",
      description: " 2017 - 2018 : I worked onsite as an Infosys resource focusing on migrating client's Telecomm applications from Windows to AWS. This role included my initial experience with data handling using DSS and SSIS for ETL server data migration and managing batch runs on UNIX servers, where I identified my unique selling point : Data Science!"
    },
    "1": {
      lat: 17.395,
      lng: 78.471,
      name: "Hyderabad",
      color: "Orange",
      description: "2012 - 2019 : I earned my BTech in CSE (2012-16) from Graphic Era University, Dehradun India. My first job as a Systems Engineer (2016-2019) in Hyderabad involved production support and maintenance, migrating a client application from Windows 2003 servers to AWS, managing revenue for a UK client, and developing database-centric applications."
    },
    "2": {
      lat: 51.506,
      lng: -0.127,
